...
func (cq *ChatQuery) GroupBy(field string, fields ...string) *ChatGroupBy {
	group := &ChatGroupBy{config: cq.config}
...
func (cq *ChatQuery) Select(fields ...string) *ChatSelect {
	...
	return &ChatSelect{ChatQuery: cq}
}
...
func (cq *ChatQuery) sqlAll(ctx context.Context) ([]*Chat, error) {
	var (
		nodes = []*Chat{}
		_spec = cq.querySpec()
	)
...
func (cgb *ChatGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChatGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChatGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChatGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChatGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChatGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChatGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChatGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChatGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChatGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChatGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChatGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChatSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChatSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChatSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChatSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChatSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChatSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChatSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChatSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChatSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChatSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChatSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChatSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{chat.Label}
	default:
		err = fmt.Errorf("ent: ChatSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
