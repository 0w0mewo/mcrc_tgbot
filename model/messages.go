...
type Message struct {
	...
	MSG       []byte     `boil:"msg" json:"msg" toml:"msg" yaml:"msg"`
...
var MessageWhere = struct {
	...
	MSG:       whereHelper__byte{field: "\"messages\".\"msg\""},
	Type:      whereHelperint64{field: "\"messages\".\"type\""},
	Timestamp: whereHelpertime_Time{field: "\"messages\".\"timestamp\""},
	ChatID:    whereHelpernull_Int64{field: "\"messages\".\"chat_id\""},
	SenderID:  whereHelpernull_Int64{field: "\"messages\".\"sender_id\""},
}
...
type messageR struct {
	Sender *Sender `boil:"Sender" json:"Sender" toml:"Sender" yaml:"Sender"`
...
var (
	messageAllColumns            = []string{"id", "msg", "type", "timestamp", "chat_id", "sender_id"}
	messageColumnsWithoutDefault = []string{}
	messageColumnsWithDefault    = []string{"id", "msg", "type", "timestamp", "chat_id", "sender_id"}
	messagePrimaryKeyColumns     = []string{"id"}
	messageGeneratedColumns      = []string{"id", "msg", "type", "timestamp", "chat_id", "sender_id"}
)
...
func (o *Message) Sender(mods ...qm.QueryMod) senderQuery {
	...
	return Senders(queryMods...)
}

// Chat pointed to by the foreign key.
func (o *Message) Chat(mods ...qm.QueryMod) chatQuery {
	queryMods := []qm.QueryMod{
...
func (messageL) LoadSender(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load Sender")
	}

	var resultSlice []*Sender
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice Sender")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for senders")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for senders")
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (messageL) LoadChat(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
...
func (o *Message) SetSender(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Sender) error {
	var err error
	if insert {
...
func (o *Message) RemoveSender(ctx context.Context, exec boil.ContextExecutor, related *Sender) error {
	var err error

	queries.SetScanner(&o.SenderID, nil)
	if err = o.Update(ctx, exec, boil.Whitelist("sender_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
...
// SetChat of the message to the related item.
// Sets o.R.Chat to related.
// Adds o to related.R.Messages.
func (o *Message) SetChat(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Chat) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Removes o from all passed in related items' relationships struct.
func (o *Message) RemoveChat(ctx context.Context, exec boil.ContextExecutor, related *Chat) error {
	var err error
